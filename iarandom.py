...
class othelloIA: #initialsation du socket 
	def __init__(self, ipbut = "localhost" ): #localhost pour jouer en local, sinon, ip du serveur 
		self.port = int(input("Port, 4098 si vide ") or 4098)
		self.ipbut = ipbut
		self.name = input("Nom IA, IA2003420342 si vide ") or "Random" #permet de donner une valeur par défaut aux input
		self.matricule1 =  input("matricule 1, 12345 si vide ") or "12345"
		self.matricule2 = input("matricule 2, 23456 si vide ") or "23456"
